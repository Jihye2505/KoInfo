...
<head>
	...
	<!--[if lt IE 9]>
		...
		window.onload = function() {
			document.getElementById("state_id").value = document.getElementById("getstate_id").value;
		};
</script>
  </head>
...
<h1 align="left">관광명소 등록</h1><br>
<form action="${ctx}/Attraction/regist?state_id=${state_id}" method="post" id="attractionCreate" enctype="multipart/form-data">
  ...
  <tbody>
    ...
    <tr><td colspan="2"><HR width="100%" align="center" style="color:black; background-color:black; height:1px; border:none" /></td></tr>
      ...
      <tr>
        <td colspan="2"><textarea type="textarea" name="content" id="content" style="width:100%; height:400px"></textarea></td>
      </tr>
          <tr><td colspan="2"><HR width="100%" align="center" style="color:black; background-color:black; height:1px; border:none" /></td></tr>
          <tr>
        <tr>
        <td colspan="2"><input type="file" name="file" id="image" style="width:100%;" required="required"></td>
      </tr>
  </tbody>
</table>
<br>
...
<input type="submit" class="btn btn-info" value="등록" onclick="create(); return false;">
<input type="hidden" id="getstate_id" value="${state_id}">
</div>
</form>
